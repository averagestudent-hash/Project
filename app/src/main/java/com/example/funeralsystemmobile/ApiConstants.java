...
public class ApiConstants {
    ...
    public static final String CasketproductsListURL = BASE_URL + "api/CasketproductsList";
    public static final String DressingproductsListURL = BASE_URL + "api/DressingproductsList";
